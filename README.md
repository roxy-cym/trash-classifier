...
In order to design a case that can protect raspberry pi, hold the camera and place the LEDs, I referred to pi cases online and made some changes to satisfy my requirements. 

# Data
The initial data I used is the Garbage Classification Dataset on Kaggle. The dataset consisted of 2340 images and five classifications: cardboard (393), glass (491), metal (400), paper(584), and plastic (472). Example pictures for each category are shown below:

                                                                                                            
<img width="300" height="300" src="https://github.com/roxy-cym/trash-classifier/blob/main/imgs/cardboard1.jpg">                                           <img width="300" height="300" src="https://github.com/roxy-cym/trash-classifier/blob/main/imgs/glass1.jpg"> 
<img width="300" height="300" src="https://github.com/roxy-cym/trash-classifier/blob/main/imgs/metal1.jpg">  
<img width="300" height="300" src="https://github.com/roxy-cym/trash-classifier/blob/main/imgs/paper1.jpg"> 
<img width="300" height="300" src="https://github.com/roxy-cym/trash-classifier/blob/main/imgs/plastic1.jpg"> 
...
The first processing of the picture is resizing the pictures. There are two kinds of picture pixels on edge impulse, 96*96 and 160*160, respectively. The accuracy of the model is higher at 160*160 pixels, so in this project, I set picture pixels as 160*160. Another parameter setting which is colour depth, was set to RGB. All objects in the dataset have their own colour. So, colour is also one of the significant factors for garbage classification.
...
- Parameter settings
- Adding more images
I thought adding more images would increase the model accuracy. On the contrary, the accuracy decreased. Then I realized that the images that I captured have lots of noise, which affects the recognition correctness of the model to a large extent. For example, there are other items in the images, the background colour and so on. Pure data can improve accuracy.
...
Sometimes the device will output a wrong prediction. Errors are mainly concentrated in misjudgment of metal, paper and plastic. Based on the colour of the objects, the model can easily give out worry predictions. For instance, if there is a glass with colour, the output might be plastic; if there is a transparent plastic bottle, the output might be glass, and if the glass or plastic has colour, the output might be metal.
...
# Reference
 1. Shalash, W.M., 2019. Driver Fatigue Detection with Single EEG Channel Using Transfer Learning, in: 2019 IEEE International Conference on Imaging Systems and Techniques (IST). IEEE.
